  ...
  container.innerHTML = DATA.cols.filter(z => 
    ...
    return `
      <div id="zone-card-${originalIdx}" class="tile-card ${selCount > 0 ? 'has-selection' : ''} ${expandedZoneId === originalIdx ? 'expanded' : ''}" 
        ...
        <div class="tile-row-2" style="text-align: left; padding-left: 2px; font-weight: 700; height: 22px; overflow: hidden;">
          <b>${getFitSpan(rawName, 19, 60)}</b>
        </div>
        
        <div class="tile-row-3 f-oswald" style="text-align: left; padding-left: 1px; color: #000 !important; font-weight: 700; height: 22px; overflow: hidden;">
